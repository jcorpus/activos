        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="form-group">
              <label class="col-sm-1 control-label">Reporte Usuarios</label>
              <div class="col-sm-8">
...
<script>
  $("#reporte_usuarios").click(function(){
        window.open("view/reportes/reporte_usuarios.php","blank");
      });
</script>
  <script src="html/javascript/list_usuario.js"></script>
