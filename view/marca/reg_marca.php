              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 <label  class="col-sm-2 control-label">Descripcion.</label>
                  ...
                  <button type="button" onclick="reg_marca()" class="btn btn-success btn-sm"><i class="fa fa-floppy-o" aria-hidden="true"></i>&ensp; Registrar</button>
                </div>
              </div>
            </form>
          </div>
...
<script src="html/javascript/marca.js"></script>