...
//$pdf->Cell(ancho, alto, contenido, borde , alineación); //Alineación L Izquierda, C Centrado, R Derecha
        ...
        $pdf->Cell(30,6,'Nombre',1,0,'C',1);//el ultimo parametro se rellena la celda
        $pdf->Cell(90,6,'unidad de medida',1,0,'C',1);
        $pdf->Cell(30,6,'Regla sanitaria',1,0,'C',1);
        $pdf->Cell(25,6,'Fecha de vencimiento',1, 1,'C',1);
    ...
    while ($row = $db->recorrer($sql)) {
        ...
        $pdf->Cell(30,6,$row["prod_Nom"],1,0,'C');
        $pdf->Cell(90,6,$row["prod_umed"],1,0,'C');
