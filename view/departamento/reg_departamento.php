...
<section class="content-header cabecera">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">departameno</li>
      </ol>
    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formulario_departamento">
              <div class="box-body">
                <!--Mensaje de registro-->
                <div class="" id="msj_depa">
                </div>
                <!--Mensaje de registro-->
                <div class="form-group">
                 <label  class="col-sm-2 control-label">Descripcion.</label>
                  ...
                  <button type="button" onclick="reg_departamento()" class="btn btn-success btn-lg"><i class="fa fa-floppy-o" aria-hidden="true"></i>&ensp; Registrar</button>
                </div>
              </div>
            </form>
          </div>
                ...
                <div class="col-md-12">
                        <div class="box-body">
                            <form class="form-horizontal" id="mformulario_marca">
                              <div class="box-body">
                                <!--Mensaje de registro-->
                                <div class="" id="msj_mod_depa">
                                </div>
                                <!--Mensaje de registro-->
                                <div class="form-group">
                                 <label  class="col-sm-2 control-label">Descripcion.</label>
                                 <div class="col-sm-4">
                                        <input type="hidden" id="id_depa2" name="id_depa2">
                                ...
                                <button type="button" onclick="mod_departamento()" class="btn btn-success btn-lg"><i class="fa fa-floppy-o" aria-hidden="true"></i>&ensp; Modificar</button>
                              </div>
                            </form>
...
<script src="html/javascript/departamento.js"></script>